<?php
	...
	*/
	...
	const DEBUG_ERROR_MESSAGE = false; // TRUE or FALSE
	...
	*/
	...
	$config = array(
		...
		*/
		 ...
		 *******************/
		'aviary_active' => true,
		'aviary_apiKey' => "271645b7742d47cdbed4141add390bde",
		'aviary_language' => "en",
		'aviary_theme' => "light",
		'aviary_tools' => "all",
		'aviary_secret' => "cfb3dc29-0876-41bb-ad7c-56b05e1284ab",
		'aviary_maxSize' => "1400",
	...
	$ext_img = array_merge($config['ext_img'], $config['ext_file'], $config['ext_misc'], $config['ext_video'], $config['ext_music']);
