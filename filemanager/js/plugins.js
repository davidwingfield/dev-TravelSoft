!function (e) {
    ...
    !function (e) {
        ...
        t.prototype.checkPosition = function () {
            if (this.$element.is(":visible")) {
                var t, n = e(document).height(), o = this.$window.scrollTop(), i = this.$element.offset(), a = this.options.offset, r = a.bottom, s = a.top, c = "affix affix-top affix-bottom"
                "object" != typeof a && (r = s = a),
                "function" == typeof s && (s = a.top()),
                "function" == typeof r && (r = a.bottom()),
                    t = !(null != this.unpin && o + this.unpin <= i.top) && (null != r && i.top + this.$element.height() >= n - r ? "bottom" : null != s && o <= s && "top"),
                this.affixed !== t && (this.affixed = t,
                    this.unpin = "bottom" === t ? i.top - o : null,
                    this.$element.removeClass(c).addClass("affix" + (t ? "-" + t : "")))
            }
        }
            ...
            toggle: function (o) {
                ...
                if (!r.is(".disabled, :disabled")) {
                    return i = n(r),
                        a = i.hasClass("open"),
                        t(),
                    a || ("ontouchstart" in document.documentElement && e('<div class="dropdown-backdrop"/>').insertBefore(e(this)).on("click", t),
                        i.toggleClass("open")),
                        r.focus(),
                        !1
                }
            ...
            keydown: function (t) {
                ...
                if (/(38|40|27)/.test(t.keyCode) && (i = e(this),
                    ...
                    if (r = n(i),
                        s = r.hasClass("open"),
                    !s || s && 27 === t.keyCode) {
                        return 27 === t.which && r.find(o).focus(),
                            i.click()
                    }
                    a = e("[role=menu] li:not(.divider):visible a", r),
                    a.length && (c = a.index(a.filter(":focus")),
                    38 == t.keyCode && c > 0 && c--,
    ...
    !function (e) {
        ...
        n.prototype.close = function (t) {
            ...
            t.isDefaultPrevented() || (o.removeClass("in"),
                e.support.transition && o.hasClass("fade") ? o.on(e.support.transition.end, n) : n())
        }
    ...
    !function (e) {
            ...
            show: function () {
                ...
                if (!this.transitioning && !this.$element.hasClass("in")) {
                    if (t = this.dimension(),
                        ...
                        o = this.$parent && this.$parent.find("> .accordion-group > .in"),
                    o && o.length) {
                        if (i = o.data("collapse"),
                        i && i.transitioning) {
                            return
                        }
                        o.collapse("hide"),
                        i || o.data("collapse", null)
                    }
                    this.$element[t](0),
        ...
        e.fn.collapse = function (n) {
            ...
            e(document).on("click.collapse.data-api", "[data-toggle=collapse]", function (t) {
                var n, o = e(this), i = o.attr("data-target") || t.preventDefault() || (n = o.attr("href")) && n.replace(/.*(?=#[^\s]+$)/, ""), a = e(i).data("collapse") ? "toggle" : o.data()
                o[e(i).hasClass("in") ? "addClass" : "removeClass"]("collapsed"),
                    e(i).collapse(a)
            })
    }(window.jQuery),
    !function (e) {
            ...
            applyPlacement: function (e, t) {
                ...
                "top" == t && o != c && (e.top = e.top + c - o,
                    ...
                    e.left < 0 && (i = e.left * -2,
                        ...
                        n = r[0].offsetWidth,
                        o = r[0].offsetHeight),
                        this.replaceArrow(i - s + n, n, "left")) : this.replaceArrow(o - c, o, "top"),
                a && r.offset(e)
            },
    ...
    !function (e) {
        ...
        function t (t, n) {
            ...
            this.options = e.extend({}, e.fn.scrollspy.defaults, n),
                ...
                this.selector = (this.options.target || (o = e(t).attr("href")) && o.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a",
                this.$body = e("body"),
                this.refresh(),
                this.process()
        }
        ...
        t.prototype = {
            ...
            process: function () {
                var e, t = this.$scrollElement.scrollTop() + this.options.offset, n = this.$scrollElement[0].scrollHeight || this.$body[0].scrollHeight, o = n - this.$scrollElement.height(), i = this.offsets, a = this.targets, r = this.activeTarget
                if (t >= o) {
                    return r != (e = a.last()[0]) && this.activate(e)
                }
                for (e = i.length; e--;)
            ...
            activate: function (t) {
                ...
                this.activeTarget = t,
                    ...
                    o = this.selector + '[data-target="' + t + '"],' + this.selector + '[href="' + t + '"]',
    ...
    !function (e) {
        ...
        t.prototype = {
            ...
            show: function () {
                ...
                r || (r = i.attr("href"),
                    r = r && r.replace(/.*(?=#[^\s]*$)/, "")),
                i.parent("li").hasClass("active") || (t = a.find(".active:last a")[0],
                    o = e.Event("show", {
                        relatedTarget: t,
                    }),
                    i.trigger(o),
                o.isDefaultPrevented() || (n = e(r),
        ...
        t.prototype = {
            ...
            render: function (t) {
                ...
                return t = e(t).map(function (t, o) {
                    return t = e(n.options.item).attr("data-value", o),
    ...
    function (e) {
        ...
        t.prototype = {
            ...
            setup: function (t, n) {
                "object" != typeof t || t instanceof e != !1 || n || (n = t,
                    t = void 0)
                ...
                return o.$instance = a.clone().addClass(o.variant),
                    o.$instance.on(o.closeTrigger + "." + o.namespace, function (t) {
                        if (!t.isDefaultPrevented()) {
                            var n = e(t.target);
                            ("background" === o.closeOnClick && n.is("." + o.namespace) || "anywhere" === o.closeOnClick || n.closest(r).length) && (o.close(t),
                                t.preventDefault())
                        }
                    }),
                    this
                ...
                if (!r) {
                    ...
                    if (a = null,
                        e.each(t.contentFilters, function () {
                            return r = n[this],
                            r.test && (a = r.test(c)),
                            !a && r.regex && c.match && c.match(r.regex) && (a = c),
                                !a
                        }),
                        !a) {
            ...
            close: function (t) {
                var n = this
                    , o = e.Deferred()
                return n.beforeClose(t) === !1 ? o.reject() : (0 === a(n).length && l(!1),
            ...
            e.extend(t, {
                ...
                attach: function (t, n, o) {
                    var i = this
                    "object" != typeof n || n instanceof e != !1 || o || (o = n,
                        n = void 0),
                        o = e.extend({}, o)
                    var a, r = o.namespace || i.defaults.namespace, s = e.extend({}, i.defaults, i.readElementConfig(t[0], r), o), c = function (r) {
                        ...
                        "shared" === u.persist ? a = u : u.persist !== !1 && c.data("featherlight-persisted", u),
    ...
    function (e) {
        ...
        function o (t, i, a) {
            return a || (a = 0),
                i.each(function () {
                    ...
                    switch ("label" === l && s.find("input, textarea, select").length && (i = s.text(),
                        s = s.children().first(),
                        c = s.get(0),
        ...
        e.ui && e.widget || (e.cleanData = function (t) {
            return function (n) {
                var o, i, a
        ...
        var i = null
            ...
            , h = function (e) {
            for (var t = 0, n = e; ;)
                if (t = Math.max(t, parseInt(n.css("z-index"), 10) || 0),
                    n = n.parent(),
                !n || !n.length || "html body".indexOf(n.prop("nodeName").toLowerCase()) > -1) {
                    break
                }
            return t
        }
            ...
            contextmenu: function (t) {
                ...
                if (
                    ...
                    && (t.preventDefault(), t.stopImmediatePropagation()), !("right" !== t.data.trigger && "demand" !== t.data.trigger && t.originalEvent || !(void 0 === t.mouseButton || !t.data || "left" == t.data.trigger && 0 === t.mouseButton || "right" == t.data.trigger && 2 === t.mouseButton) || n.hasClass("context-menu-active") || n.hasClass("context-menu-disabled"))) {
                    if (i = n, t.data.build) {
                        var o = t.data.build(i, t)
                        if (o === !1) {
                            return
                        }
                        if (t.data = e.extend(!0, {}, d, t.data, o || {}),
                    ...
                    for (var r in t.data.items)
                        if (t.data.items.hasOwnProperty(r)) {
                            var s
                            s = e.isFunction(t.data.items[r].visible) ? t.data.items[r].visible.call(e(t.currentTarget), r, t.data) : "undefined" == typeof r.visible || t.data.items[r].visible === !0,
                            s && (a = !0)
                        }
            ...
            mousedown: function (t) {
                var n = e(this)
                i && i.length && !i.is(n) && i.data("contextMenu").$menu.trigger("contextmenu:hide"),
                2 === t.button && (i = n.data("contextMenuActive", !0))
            },
            mouseup: function (t) {
                var n = e(this)
                n.data("contextMenuActive") && i && i.length && i.is(n) && !n.hasClass("context-menu-disabled") && (t.preventDefault(),
                    t.stopImmediatePropagation(),
                    i = n,
                    n.trigger(e.Event("contextmenu", {
                        data: t.data,
                        pageX: t.pageX,
                        pageY: t.pageY,
                    }))),
            ...
            mouseenter: function (t) {
                var n = e(this)
                    , o = e(t.relatedTarget)
                    , a = e(document)
                o.is(".context-menu-list") || o.closest(".context-menu-list").length || i && i.length || (f.pageX = t.pageX,
                    f.pageY = t.pageY,
                    f.data = t.data,
            ...
            layerClick: function (t) {
                ...
                t.preventDefault(),
                    ...
                    setTimeout(function () {
                        ...
                        if (document.elementFromPoint && a.$layer && (a.$layer.hide(),
                            n = document.elementFromPoint(c - r.scrollLeft(), l - r.scrollTop()),
                            a.$layer.show()),
                        a.reposition && u) {
                            if (document.elementFromPoint) {
                                if (a.$trigger.is(n) || a.$trigger.has(n).length) {
                                    return void a.position.call(a.$trigger, a, c, l)
                                }
                            } else if (o = a.$trigger.offset(),
                                i = e(window),
                                o.top += i.scrollTop(),
                            o.top <= t.pageY && (o.left += i.scrollLeft(),
                            o.left <= t.pageX && (o.bottom = o.top + a.$trigger.outerHeight(),
                            o.bottom >= t.pageY && (o.right = o.left + a.$trigger.outerWidth(),
                            o.right >= t.pageX)))) {
                                return void a.position.call(a.$trigger, a, c, l)
                            }
                        }
            ...
            key: function (e) {
                ...
                switch (i && (t = i.data("contextMenu") || {}),
                    ...
                    case 39:
                        ...
                        if (o.$menu && t.$selected.hasClass("context-menu-submenu")) {
                    ...
                    case 27:
                        return p.keyStop(e, t),
                            void t.$menu.trigger("contextmenu:hide")
                    default:
                        var a = String.fromCharCode(e.keyCode).toUpperCase()
                        if (t.accesskeys && t.accesskeys[a]) {
                            return void t.accesskeys[a].$node.trigger(t.accesskeys[a].$menu ? "contextmenu:focus" : "mouseup")
                        }
                }
                e.stopPropagation(),
                "undefined" != typeof t.$selected && null !== t.$selected && t.$selected.trigger(e)
            },
            prevItem: function (t) {
                t.stopPropagation()
                ...
                for (var a = n.$menu.children(), r = n.$selected && n.$selected.prev().length ? n.$selected.prev() : a.last(), s = r; r.hasClass(o.classNames.disabled) || r.hasClass(o.classNames.notSelectable);)
                    if (r = r.prev().length ? r.prev() : a.last(),
                        r.is(s)) {
                        return
                    }
            ...
            nextItem: function (t) {
                ...
                for (var a = n.$menu.children(), r = n.$selected && n.$selected.next().length ? n.$selected.next() : a.first(), s = r; r.hasClass(o.classNames.disabled) || r.hasClass(o.classNames.notSelectable);)
                    if (r = r.next().length ? r.next() : a.first(),
                        r.is(s)) {
                        return
                    }
                n.$selected && p.itemMouseleave.call(n.$selected.get(0), t),
            ...
            itemMouseenter: function (t) {
                var n = e(this)
                    ...
                    , a = o.contextMenuRoot
                return a.hovering = !0,
                t && a.$layer && a.$layer.is(t.relatedTarget) && (t.preventDefault(),
                    t.stopImmediatePropagation()),
                    (i.$menu ? i : a).$menu.children(".hover").trigger("contextmenu:blur"),
                    n.hasClass(a.classNames.disabled) || n.hasClass(a.classNames.notSelectable) ? void (i.$selected = null) : void n.trigger("contextmenu:focus")
            },
            itemMouseleave: function (t) {
                var n = e(this)
                    ...
                    , i = o.contextMenu
                    , a = o.contextMenuRoot
                return a !== i && a.$layer && a.$layer.is(t.relatedTarget) ? ("undefined" != typeof a.$selected && null !== a.$selected && a.$selected.trigger("contextmenu:blur"),
                    t.preventDefault(),
                    t.stopImmediatePropagation(),
                    void (a.$selected = i.$selected = i.$node)) : void n.trigger("contextmenu:blur")
            },
            itemClick: function (t) {
                ...
                if (a.items[s] && !o.is("." + r.classNames.disabled + ", .context-menu-submenu, .context-menu-separator, ." + r.classNames.notSelectable)) {
                    if (t.preventDefault(),
                        t.stopImmediatePropagation(),
                    e.isFunction(r.callbacks[s]) && Object.prototype.hasOwnProperty.call(r.callbacks, s)) {
                        n = r.callbacks[s]
                    } else {
            ...
            focusItem: function (t) {
                ...
                var n = e(this)
                    ...
                    , i = o.contextMenu
                    , a = o.contextMenuRoot
                n.addClass([a.classNames.hover, a.classNames.visible].join(" ")).siblings().removeClass(a.classNames.visible).filter(a.classNames.hover).trigger("contextmenu:blur"),
            ...
            show: function (t, n, o) {
                var a = e(this)
                    , r = {}
                return e("#context-menu-layer").trigger("mousedown"),
                    t.$trigger = a,
                    t.events.show.call(a, t) === !1 ? void (i = null) : (m.update.call(a, t),
                        t.position.call(a, t, n, o),
                    t.zIndex && (r.zIndex = h(a) + t.zIndex),
                        m.layer.call(t.$menu, t, r.zIndex),
                        t.$menu.find("ul").css("zIndex", r.zIndex + 1),
                        t.$menu.css(r)[t.animation.show](t.animation.duration, function () {
                            a.trigger("contextmenu:visible")
                        }),
                        a.data("contextMenu", t).addClass("context-menu-active"),
                        e(document).off("keydown.contextMenu").on("keydown.contextMenu", p.key),
                        void (t.autoHide && e(document).on("mousemove.contextMenuAutoHide", function (e) {
                            ...
                            !t.$layer || t.hovering || e.pageX >= n.left && e.pageX <= n.right && e.pageY >= n.top && e.pageY <= n.bottom || t.$menu.trigger("contextmenu:hide")
                        })))
            },
            hide: function (t, n) {
                var o = e(this)
            ...
            create: function (n, o) {
                function i (t) {
                    var n = e("<span></span>")
                    return t._accesskey ? (t._beforeAccesskey && n.append(document.createTextNode(t._beforeAccesskey)),
                        e("<span></span>").addClass("context-menu-accesskey").text(t._accesskey).appendTo(n),
                    t._afterAccesskey && n.append(document.createTextNode(t._afterAccesskey))) : n.text(t.name),
                        n
                }
                
                void 0 === o && (o = n),
                    n.$menu = e('<ul class="context-menu-list"></ul>').addClass(n.className || "").data({
                        contextMenu: n,
                        contextMenuRoot: o,
                    }),
                        ...
                        if (r.type && u[r.type]) {
                            u[r.type].call(s, r, n, o),
                                e.each([n, o], function (t, n) {
                                    n.commands[a] = r,
                                    e.isFunction(r.callback) && (n.callbacks[a] = r.callback)
                                })
                        } else {
                            switch ("cm_seperator" === r.type ? s.addClass("context-menu-separator " + o.classNames.notSelectable) : "html" === r.type ? s.addClass("context-menu-html " + o.classNames.notSelectable) : r.type ? (c = e("<label></label>").appendTo(s),
                                i(r).appendTo(c),
                                ...
                                case "text":
                                    ...
                                    break
                                case "textarea":
                                    l = e('<textarea name=""></textarea>').attr("name", "context-menu-input-" + a).val(r.value || "").appendTo(c),
                                ...
                                case "radio":
                                    ...
                                    break
                                case "select":
                                    l = e('<select name="">').attr("name", "context-menu-input-" + a).appendTo(c),
                                    r.options && (e.each(r.options, function (t, n) {
                            ...
                            r.type && "sub" !== r.type && "html" !== r.type && "cm_seperator" !== r.type && (l.on("focus", p.focusInput).on("blur", p.blurInput),
                            r.events && l.on(r.events, n)),
                            r.icon && (e.isFunction(r.icon) ? r._icon = r.icon.call(this, this, s, a, r) : r._icon = o.classNames.icon + " " + o.classNames.icon + "-" + r.icon,
                                s.addClass(r._icon))
                        }
                        r.$input = l,
                            r.$label = c,
                            s.appendTo(n.$menu),
                        !n.hasTypes && e.support.eventSelectstart && s.on("selectstart.disableTextSelect", p.abortevent)
                    }),
                n.$node || n.$menu.css("display", "none").addClass("context-menu-root"),
            ...
            update: function (t, n) {
                ...
                void 0 === n && (n = t,
                    ...
                    t.$menu.children().each(function () {
                        var i, a = e(this), r = a.data("contextMenuKey"), s = t.items[r], c = e.isFunction(s.disabled) && s.disabled.call(o, r, n) || s.disabled === !0
                        if (i = e.isFunction(s.visible) ? s.visible.call(o, r, n) : "undefined" == typeof s.visible || s.visible === !0,
                            a[i ? "show" : "hide"](),
                            a[c ? "addClass" : "removeClass"](n.classNames.disabled),
                        e.isFunction(s.icon) && (a.removeClass(s._icon),
                            s._icon = s.icon.call(this, o, a, r, s),
                            a.addClass(s._icon)),
                            s.type) {
                            switch (a.find("input, select, textarea").prop("disabled", c),
                                s.type) {
                                case "text":
                                case "textarea":
                                    s.$input.val(s.value || "")
        ...
        e.fn.contextMenu = function (t) {
            ...
            if (this.length > 0) {
                if (void 0 === t) {
                    ...
                    this.first().trigger(e.Event("contextmenu", {
                        pageX: t.x,
                        pageY: t.y,
                    ...
                    "destroy" === t ? e.contextMenu("destroy", {
                        context: this,
                    }) : e.isPlainObject(t) ? (t.context = this,
                        e.contextMenu("create", t)) : t ? this.removeClass("context-menu-disabled") : t || this.addClass("context-menu-disabled")
                }
            } else {
                e.each(l, function () {
            ...
            e.contextMenu = function (t, n) {
                ...
                var o = e.extend(!0, {}, d, n || {})
                    ...
                    , r = i
                    , u = !1
                switch (o.context && o.context.length ? (r = e(o.context).first(),
                    o.context = r.get(0),
                    u = o.context !== document) : o.context = document,
                    t) {
                    case "create":
                        if (!o.selector) {
                        ...
                        a || (i.on({
                            ...
                            a = !0),
                            r.on("contextmenu" + o.ns, o.selector, o, p.contextmenu),
                        u && r.on("remove" + o.ns, function () {
                    ...
                    case "destroy":
                        ...
                        if (u) {
                            ...
                            e.each(l, function (t, n) {
                                ...
                                f = e(".context-menu-list").filter(":visible"),
                                f.length && f.data().contextMenuRoot.$trigger.is(e(n.context).find(n.selector)) && f.trigger("contextmenu:hide", {
                                    force: !0,
                                })
                                try {
                                ...
                                return e(n.context).off(n.ns),
                                    !0
                            })
                        } else if (o.selector) {
                            if (c[o.selector]) {
                                f = e(".context-menu-list").filter(":visible"),
                                f.length && f.data().contextMenuRoot.$trigger.is(o.selector) && f.trigger("contextmenu:hide", {
                                    force: !0,
                                })
                                try {
                                    l[c[o.selector]].$menu && l[c[o.selector]].$menu.remove(),
...
!function (e, t) {
    ...
    function t (e, t, n) {
        var o = t._settings
        !n && d(e) || (j(o.callback_enter, e),
        q.indexOf(e.tagName) > -1 && (z(e, t),
            A(e, o.class_loading)),
            I(e, t),
            u(e),
            j(o.callback_set, e))
    ...
    var n = {
        ...
        return i ? (i(e, n),
            ...
            void (t._elements = m(t._elements, e))) : void O(e, n)
    }
        , A = function (e, t) {
    ...
    return V.prototype = {
        ...
        _updateLoadingCount: function (e) {
            ...
            0 === this._elements.length && 0 === this._loadingCount && j(this._settings.callback_finish)
        },
        update: function (e) {
            var t = this
                , n = this._settings
                , o = e || n.container.querySelectorAll(n.elements_selector)
            return this._elements = p(Array.prototype.slice.call(o)),
                x || !this._observer ? void this.loadAll() : void this._elements.forEach(function (e) {
        ...
        n.scrollstart = {
            setup: function (i) {
                var a, r = e.extend({
                    ...
                    var n = this
                        , o = arguments
                    a ? clearTimeout(a) : (e.type = "scrollstart",
                        t.apply(n, o)),
    ...
    d.setLocale = function (e) {
        ...
        d.alert = function () {
            ...
            switch (arguments.length) {
                ...
                case 2:
                    e = arguments[0],
                        "function" == typeof arguments[1] ? o = arguments[1] : t = arguments[1]
                    break
                case 3:
                    e = arguments[0],
                        t = arguments[1],
        ...
        d.confirm = function () {
            ...
            switch (arguments.length) {
                ...
                case 3:
                    e = arguments[0],
                        t = arguments[1],
                        "function" == typeof arguments[2] ? i = arguments[2] : o = arguments[2]
                    break
                case 4:
                    e = arguments[0],
                        t = arguments[1],
        ...
        d.prompt = function () {
            ...
            switch (arguments.length) {
                ...
                case 2:
                    e = arguments[0],
                        "function" == typeof arguments[1] ? a = arguments[1] : o = arguments[1]
                    break
                case 3:
                    e = arguments[0],
                        o = arguments[1],
                        "function" == typeof arguments[2] ? a = arguments[2] : i = arguments[2]
                    break
                case 4:
                    e = arguments[0],
                        o = arguments[1],
        ...
        d.dialog = function (n, o, i) {
            ...
            var u = ""
                , d = []
            i || (i = {}),
                "undefined" == typeof o ? o = [] : "undefined" == typeof o.length && (o = [o])
            for (var f = o.length; f--;) {
                ...
                if ("undefined" == typeof o[f].label && "undefined" == typeof o[f]["class"] && "undefined" == typeof o[f].callback) {
                    ...
                    1 == y && "function" == typeof o[f][x] && (o[f].label = b,
                        o[f].callback = o[f][x])
                }
                "function" == typeof o[f].callback && (g = o[f].callback),
                    o[f]["class"] ? m = o[f]["class"] : f == o.length - 1 && o.length <= 2 && (m = "btn-primary"),
                o[f].link !== !0 && (m = "btn " + m),
                    h = o[f].label ? o[f].label : "Option " + (f + 1),
                o[f].icon && (v = "<i class='" + o[f].icon + "'></i> "),
                    p = o[f].href ? o[f].href : s,
                    u = "<a data-handler='" + f + "' class='" + m + "' href='" + p + "'>" + v + h + "</a>" + u,
                    d[f] = g
            }
            var w = ["<div class='bootbox modal' tabindex='-1' style='overflow:hidden;'>"]
            if (i.header) {
                var k = "";
                ("undefined" == typeof i.headerCloseButton || i.headerCloseButton) && (k = "<a href='" + s + "' class='close'>&times;</a>"),
                    w.push("<div class='modal-header'>" + k + "<h3>" + i.header + "</h3></div>")
            }
            ...
            return T && $.addClass(T),
                ...
                $.on("click", ".modal-footer a", function (e) {
                    var n = t(this).data("handler")
                        , i = d[n]
                        , a = null
                    "undefined" != typeof n && "undefined" != typeof o[n].href || (e.preventDefault(),
        ...
        d.modal = function () {
            ...
            switch (arguments.length) {
                ...
                case 2:
                    e = arguments[0],
                        "object" == typeof arguments[1] ? o = arguments[1] : n = arguments[1]
                    break
                case 3:
                    e = arguments[0],
                        n = arguments[1],
        ...
        function n (t, n) {
            function o (t) {
                if (!(le() || e(t.target).closest(n.excludedElements, Ye).length > 0)) {
                    ...
                    if (!o.pointerType || "mouse" != o.pointerType || 0 != n.fallbackToMouseEvents) {
                        ...
                        return Qe = w,
                            a ? Ue = a.length : n.preventDefaultEvents !== !1 && t.preventDefault(),
                            De = 0,
                            Le = null,
                            Pe = null,
                            ze = null,
                            ...
                            se(),
                            de(0, r),
                            !a || Ue === n.fingers || n.fingers === b || z() ? (Be = Te(),
                            2 == Ue && (de(1, a[1]),
                                Fe = He = be(Xe[0].start, Xe[1].start)),
                            (n.swipeStatus || n.pinchStatus) && (i = D(o, Qe))) : i = !1,
                            i === !1 ? (Qe = C,
                                D(o, Qe),
                                i) : (n.hold && (tt = setTimeout(e.proxy(function () {
                                Ye.trigger("hold", [o.target]),
                                n.hold && (i = n.hold.call(Ye, o, o.target))
            ...
            function O (e) {
                ...
                if (Qe !== $ && Qe !== C && !ce()) {
                    ...
                    n.hold && clearTimeout(tt),
                        Qe = k,
                    2 == Ue && (0 == Fe ? (de(1, i[1]),
                        Fe = He = be(Xe[0].start, Xe[1].start)) : (fe(i[1]),
                    ...
                    Ue === n.fingers || n.fingers === b || !i || z()) {
                        ...
                        !n.triggerOnTouchEnd || n.triggerOnTouchLeave) {
                            ...
                            !n.triggerOnTouchEnd && s ? Qe = j(k) : n.triggerOnTouchLeave && !s && (Qe = j($)),
                            Qe != C && Qe != $ || D(t, Qe)
                        }
                    } else {
                        Qe = C,
            ...
            function S (e) {
                ...
                return ce() && (Ue = Ze),
                    ...
                    Re = ye(),
                    R() || !P() ? (Qe = C,
                        D(t, Qe)) : n.triggerOnTouchEnd || n.triggerOnTouchEnd === !1 && Qe === k ? (n.preventDefaultEvents !== !1 && e.cancelable !== !1 && e.preventDefault(),
                        Qe = $,
                        D(t, Qe)) : !n.triggerOnTouchEnd && V() ? (Qe = $,
                        L(t, Qe, p)) : Qe === k && (Qe = C,
                        D(t, Qe)),
                    ue(!1),
                    null
            ...
            function j (e) {
                var t = e
                    ...
                    , i = P()
                    , a = R()
                return !o || a ? t = C : !i || e != k || n.triggerOnTouchEnd && !n.triggerOnTouchLeave ? !i && e == $ && n.triggerOnTouchLeave && (t = C) : t = $,
                    t
            }
            
            function D (e, t) {
                var n, o = e.touches
                return (U() || Q()) && (n = L(e, t, f)),
                (q() || z()) && n !== !1 && (n = L(e, t, h)),
                    ie() && n !== !1 ? n = L(e, t, m) : ae() && n !== !1 ? n = L(e, t, v) : oe() && n !== !1 && (n = L(e, t, p)),
                t === C && I(e),
            ...
            function L (t, o, u) {
                var d
                if (u == f) {
                    if (Ye.trigger("swipeStatus", [o, Le || null, De || 0, Re || 0, Ue, Xe, Pe]),
                    n.swipeStatus && (d = n.swipeStatus.call(Ye, t, o, Le || null, De || 0, Re || 0, Ue, Xe, Pe),
                    d === !1)) {
                        return !1
                    }
                    if (o == $ && Y()) {
                        ...
                        n.swipe && (d = n.swipe.call(Ye, t, Le, De, Re, Ue, Xe, Pe),
                        d === !1)) {
                            return !1
                        }
                        switch (Le) {
                            case i:
                                Ye.trigger("swipeLeft", [Le, De, Re, Ue, Xe, Pe]),
                                n.swipeLeft && (d = n.swipeLeft.call(Ye, t, Le, De, Re, Ue, Xe, Pe))
                                break
                            case a:
                                Ye.trigger("swipeRight", [Le, De, Re, Ue, Xe, Pe]),
                                n.swipeRight && (d = n.swipeRight.call(Ye, t, Le, De, Re, Ue, Xe, Pe))
                                break
                            case r:
                                Ye.trigger("swipeUp", [Le, De, Re, Ue, Xe, Pe]),
                                n.swipeUp && (d = n.swipeUp.call(Ye, t, Le, De, Re, Ue, Xe, Pe))
                                break
                            case s:
                                Ye.trigger("swipeDown", [Le, De, Re, Ue, Xe, Pe]),
                                n.swipeDown && (d = n.swipeDown.call(Ye, t, Le, De, Re, Ue, Xe, Pe))
                        }
                    }
                }
                if (u == h) {
                    if (Ye.trigger("pinchStatus", [o, ze || null, We || 0, Re || 0, Ue, Ke, Xe]),
                    n.pinchStatus && (d = n.pinchStatus.call(Ye, t, o, ze || null, We || 0, Re || 0, Ue, Ke, Xe),
                    d === !1)) {
                        return !1
                    }
                    if (o == $ && W()) {
                        switch (ze) {
                            case c:
                                Ye.trigger("pinchIn", [ze || null, We || 0, Re || 0, Ue, Ke, Xe]),
                                n.pinchIn && (d = n.pinchIn.call(Ye, t, ze || null, We || 0, Re || 0, Ue, Ke, Xe))
                                break
                            case l:
                                Ye.trigger("pinchOut", [ze || null, We || 0, Re || 0, Ue, Ke, Xe]),
                                n.pinchOut && (d = n.pinchOut.call(Ye, t, ze || null, We || 0, Re || 0, Ue, Ke, Xe))
                        }
                    }
                }
                return u == p ? o !== C && o !== $ || (clearTimeout(et),
                    clearTimeout(tt),
                    G() && !ee() ? (Je = Te(),
                        ...
                        Ye.trigger("tap", [t.target]),
                    n.tap && (d = n.tap.call(Ye, t, t.target)))) : u == m ? o !== C && o !== $ || (clearTimeout(et),
                    clearTimeout(tt),
                    Je = null,
                    Ye.trigger("doubletap", [t.target]),
                n.doubleTap && (d = n.doubleTap.call(Ye, t, t.target))) : u == v && (o !== C && o !== $ || (clearTimeout(et),
                    Je = null,
                    Ye.trigger("longtap", [t.target]),
                n.longTap && (d = n.longTap.call(Ye, t, t.target)))),
                    d
            }
            ...
            function R () {
                var e = !1
                return null !== n.cancelThreshold && null !== Le && (e = me(Le) - De >= n.cancelThreshold),
                    e
            }
            ...
            function pe (e, t) {
                e != u && (t = Math.max(t, me(e)),
                    qe[e].distance = t)
            }
            
            function me (e) {
                if (qe[e]) {
                    return qe[e].distance
                }
            }
        ...
        return function t (e, n, o) {
                            ...
                            return r(e, [
                                {
                                    ...
                                    set: function (e) {
                                        if (void 0 !== e) {
                                            if (!e || "object" !== ("undefined" == typeof e ? "undefined" : a(e)) || 1 !== e.nodeType) {
            ...
            8: [
                function (t, n, o) {
                    !function (i, a) {
                        if ("function" == typeof e && e.amd) {
                            e(["module", "./clipboard-action", "tiny-emitter", "good-listener"], a)
                        } else if ("undefined" != typeof o) {
                            a(n, t("./clipboard-action"), t("tiny-emitter"), t("good-listener"))
                        } else {
                            var r = {
                                exports: {},
                            }
    ...
    function (e) {
        function t (e, t) {
            if (!(e.originalEvent.touches.length > 1)) {
                ...
                o.initMouseEvent(t, !0, !0, window, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null),
        ...
        if (e.support.touch = "ontouchend" in document,
            ...
            o._touchStart = function (e) {
                var o = this
                !n && o._mouseCapture(e.originalEvent.changedTouches[0]) && (n = !0,
                    o._touchMoved = !1,
                    t(e, "mouseover"),
                    t(e, "mousemove"),
                    t(e, "mousedown"))
