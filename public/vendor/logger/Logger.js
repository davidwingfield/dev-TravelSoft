...
let Logger = (function () {
    ...
    let getRequestAnimationFrameFunction = function () {
        let requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || window.webkitRequestAnimationFrame
    ...
    let self = {
        ...
        init: function () {
            ...
            if (!containerDiv) {
                ...
                containerDiv.setAttribute("style", "width:100%;" + "margin:0;" + "padding:0;" + "text-align:left;" + "box-sizing:border-box;" + "position:fixed;" + "left:0;" + "z-index:" + Z_INDEX + ";" + "bottom:" + (-logHeight) + "px;") /* hide it initially */
                
                // tab
                tabDiv = document.createElement("div")
                tabDiv.id = TAB_DIV
                tabDiv.appendChild(document.createTextNode("LOG"))
                tabDiv.setAttribute("style", "width:40px;" + "box-sizing:border-box;" + "overflow:hidden;" + "font:bold 10px verdana,helvetica,sans-serif;" + "line-height:" + (tabHeight - 1) + "px;" + /* subtract top-border */ "color:#fff;" + "position:absolute;" + "left:20px;" + "top:" + -tabHeight + "px;" + "margin:0; padding:0;" + "text-align:center;" + "border:1px solid #aaa;" + "border-bottom:none;" +
                  /*"background:#333;" + */"background:rgba(0,0,0,0.8);" + "border-top-right-radius:8px;" + "border-top-left-radius:8px;")
                ...
                logDiv.id = LOG_DIV
                logDiv.setAttribute("style", "font:12px monospace;" + "height: " + logHeight + "px;" + "box-sizing:border-box;" + "color:#fff;" + "overflow-x:hidden;" + "overflow-y:scroll;" + "visibility:hidden;" + "position:relative;" + "bottom:0px;" + "margin:0px;" + "padding:5px;" +
                  /*"background:#333;" + */"background:rgba(0,0,0,0.8);" + "border-top:1px solid #aaa;")
                ...
                let msg = "===== Log Started at " + getDate() + ", " + getTime() + ", " + "(Logger version " + version + ") " + "====="
        ...
        print: function (title, msg) {
            ...
            if (typeof msg == "undefined") //
            {
                 ...
                 */
                baseColor = "#ffd9aa"
                let p = (msg === true || msg === 1)
                msg = t + " (boolean): " + p
                msgDefined = false
            } else if (typeof msg == "number") {
                /**
                 * print "number" if param is function ptr
                 */
                baseColor = "#feaaff"
                msg = t + " (number): " + msg
                msgDefined = false
                ...
                /**
                 * print "string" if param is function ptr
                 */
                baseColor = "#fff"
                msg = t + " (string): " + msg
                msgDefined = false
                 ...
                 * print "function" if param is function ptr
                 */
                let content = msg.toString().split("\r\n")
                ...
                /**
                 * print "null" if param is function ptr
                 */
                msg = t + " (null): "
                msgDefined = false
            } else if (typeof msg == "object") {
                /**
                 * print "object" if param is function ptr
                 */
                baseColor = "#aab8ff"
                msg = t + " (object): " + JSON.stringify(msg, undefined, 4)
                msgDefined = false
            } else if (msg instanceof Array) {
                /**
                 * print "array" if param is function ptr
                 */
                msg = t + " (array): " + this.arrayToString(msg)
                msgDefined = false
            } else {
                /**
                 * or other types
            ...
            for (let i = 0, c = lines.length; i < c; ++i) {
                ...
                let emptyTimeDiv = document.createElement("div")
                emptyTimeDiv.setAttribute("style", "color:#999;" + "float:left;")
                let timeNode = document.createTextNode(getTime() + "\u00a0")
                let blankTimeNode = document.createTextNode("        " + "\u00a0")
                emptyTimeDiv.appendChild(blankTimeNode)
                ...
                if (!msgDefined) {
                    msgDiv.style.color = baseColor//"#afa"
                ...
                if (i === 0) {
                    ...
                    logDiv.appendChild(emptyTimeDiv)
                }
